    ...
    try:          
        ...
        df = sparkSession.sql("""  SELECT 
                                            ...
                                            FROM (
                                            	...
                                            	JOIN MBF_BIGDATA.ADMD_CHURN_KPI_MO B ON A.SERVICE_NBR = B.SERVICE_NBR AND A.ACCT_SRVC_INSTANCE_KEY = B.ACCT_SRVC_INSTANCE_KEY AND B.MO_KEY = '""" + mo_key + """' 
                                            	WHERE A.MO_KEY = '202211' AND A.CHURN_IND = 1                                                                           
                                            ) A
                                            LEFT JOIN MBF_BIGDATA.ADMR_ACCOUNT_SERVICE B ON A.SERVICE_NBR = B.SERVICE_NBR AND A.ACCT_SRVC_INSTANCE_KEY = B.ACCT_SRVC_INSTANCE_KEY AND B.DAY_KEY = '20221031'
                                            WHERE A.PROD_LINE_KEY = 2""")                                                                                      
